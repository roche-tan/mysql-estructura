...
CREATE TABLE `payment_data` (
  `id_payment_data` int NOT NULL AUTO_INCREMENT,
  `id_subscription` int NOT NULL,
  `date_payment` datetime NOT NULL,
  `amount` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id_payment_data`),
  KEY `id_subscription` (`id_subscription`),
  CONSTRAINT `payment_data_ibfk_1` FOREIGN KEY (`id_subscription`) REFERENCES `subscriptions` (`id_subscription`)
...
INSERT INTO `payment_data` VALUES (1,1,'2023-01-01 00:00:00',9.99),(2,2,'2023-01-15 00:00:00',19.99);
