...
CREATE TABLE `sales` (
  ...
  `sales_period` enum('Q1','Q2','Q3','Q4') DEFAULT NULL,
  PRIMARY KEY (`id_sale`),
  KEY `id_customer` (`id_customer`),
  KEY `id_employee` (`id_employee`),
  KEY `id_glasses` (`id_glasses`),
  CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`id_customer`) REFERENCES `customers` (`id_customer`),
  CONSTRAINT `sales_ibfk_2` FOREIGN KEY (`id_employee`) REFERENCES `employees` (`id_employee`),
...
INSERT INTO `sales` VALUES (1,'2023-12-01 10:00:00',1,2,3,'Q2'),(2,'2023-12-05 15:30:00',2,1,1,'Q3'),(3,'2023-12-10 11:45:00',3,3,2,'Q4'),(4,'2023-12-10 11:45:00',3,3,4,'Q4');
