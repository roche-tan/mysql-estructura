...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`id_video`) REFERENCES `videos` (`id_video`)
...
INSERT INTO `comments` VALUES (1,2,'¡Gran video, muy informativo!','2023-01-13 09:00:00',2),(2,1,'¡Me encanta este vlog de viajes!','2023-01-15 08:30:00',1);
