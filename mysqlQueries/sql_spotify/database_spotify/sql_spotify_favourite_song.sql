...
CREATE TABLE `favourite_song` (
  `id_favourite_song` int NOT NULL AUTO_INCREMENT,
  `id_user` int NOT NULL,
  `id_song` int NOT NULL,
  PRIMARY KEY (`id_favourite_song`),
  KEY `id_user` (`id_user`),
  KEY `id_song` (`id_song`),
  CONSTRAINT `favourite_song_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`),
  CONSTRAINT `favourite_song_ibfk_2` FOREIGN KEY (`id_song`) REFERENCES `song` (`id_song`)
...
INSERT INTO `favourite_song` VALUES (1,1,1),(2,2,2);
