...
CREATE TABLE `favourite_album` (
  `id_favourite_album` int NOT NULL AUTO_INCREMENT,
  `id_user` int NOT NULL,
  `id_artist` int NOT NULL,
  PRIMARY KEY (`id_favourite_album`),
  KEY `id_user` (`id_user`),
  KEY `id_artist` (`id_artist`),
  CONSTRAINT `favourite_album_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`),
  CONSTRAINT `favourite_album_ibfk_2` FOREIGN KEY (`id_artist`) REFERENCES `artist` (`id_artist`)
...
INSERT INTO `favourite_album` VALUES (1,1,1),(2,2,2);
